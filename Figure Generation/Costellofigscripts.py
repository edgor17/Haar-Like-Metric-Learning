...
folder='Haar-Like-Metric-Learning/Raw_data/Costello'
...
plotters.Unifracplot3d(Dwunifrac,dic=dic,y=Y.values,tasktype='classification',title='Weighted UniFrac',save=False,path=False)
...
plotters.biplot3d(model,mags,Y.values.astype(float),'classification',dic,k=7,n=7,save=False,path=False)
plotters.biplot3dnormalized(model,mags,Y.values.astype(float),'classification',dic,k=7,n=3,save=False,path=False)

plotters.boxplot(mags,Y.values,model.coordinates[0:7],dic,dic.keys(),False,False)
